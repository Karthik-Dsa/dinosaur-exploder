...
/**
 * Summary : The Factory handles the creation of Background , Player , Score , Life , Dino,
 * Explosion
 */
public class GameEntityFactory implements EntityFactory {
  ...
  /** Summary : New Players creation will be handled in below Entity */
  @Spawns("player")
  ...
  /** Summary : New Green Dino creation will be handled in below Entity */
  @Spawns("greenDino")
  ...
  /** Summary : Setting up the Score will be handled in below Entity */
  @Spawns("Score")
  ...
  /** Summary : Life text will be handled in below Entity */
  @Spawns("Life")
  ...
  public Entity newExplosion(SpawnData data) {
    ...
    AnimationChannel ac = new AnimationChannel(FXGL.image("explosion.png"), seconds, 16);

    AnimatedTexture at = new AnimatedTexture(ac);
    at.play();
    return FXGL.entityBuilder(data).view(at).with(new ExpireCleanComponent(seconds)).build();
  }
  ...
  /** Summary : Creates level progress bar */
